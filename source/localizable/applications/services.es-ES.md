Un [`Ember.Service`](http://emberjs.com/api/classes/Ember.Service.html) es un largo vivido objeto de Ember que puede estar disponible en partes differentes de la applicacion. 
